...
<?php echo do_shortcode( '[searchandfilter fields="search,product_cat,taxonomyone,taxonomytwo" empty_search_url="http://localhost/ProyectosGuebsite/rentobregon/tienda/" search_placeholder="Buscar propiedades en Cd.Obregón" submit_label="Buscar"]' ); ?>